Config.Logs = {
    ...
    AdvancedLog = {
        ...
        actived = {
            Ban = true, -- Log the ban action
            TBP = true, -- Trigger Basic Protection (the anti trigger)
            Startup = true, -- Startup info
            Building = true, -- Log the build/demolish for any uEntity
            ...
            NoIdentifier = true, -- Any connection to the server without the identifier
            ...
            Vehicle = true, -- Log any vehicle action
            Society = true, -- Log any society action
            Trunk = true, -- Log any trunk transition
            Development = true, -- Log any development info (not for normal users)
        }
    }
}