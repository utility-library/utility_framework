...
CreateMenu = function(title, content, cb, close)
    ...
    print(json.encode({open = true, closeLabel=Config.Labels["framework"]["MenuCloseLabel"], title = title}))
    SendNUIMessage({open = true,content = content, closeLabel=Config.Labels["framework"]["MenuCloseLabel"], title = title})
