RegisterNetEvent("Utility:Weather:Transition")
AddEventHandler("Utility:Weather:Transition", function(NewWeather)
...
AddEventHandler("Utility:Weather:SetTime", function(hour, minute)
    --print("Setting time "..hour.." "..minute)
